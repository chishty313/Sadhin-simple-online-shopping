...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Logged In User token:", token, "User:", user);
    dispatch(setToken(token));
    dispatch(setUser(user));
  };
  return (
    <div className="min-h-screen rounded-xl flex items-center justify-center bg-gradient-to-r from-green-800 via-red-700 to-green-600">
